...
<div class="flex-1 flex">
    ...
    <div class="bg-white w-1/4 py-4 px-4">
        ...
        <h2 class="text-3xl text-gray-700 font-medium">Edit</h2>
        ...
        <form action="<?= $this->home ?>/<?= $this->model->spot_id ?>/edit" method="post">
            <div id="search-bar" class="flex">
                <div class="relative w-full mb-4">
                    ...
                    <input type="hidden" id="trefle_id" name="trefle_id" value="<?= $this->model->trefle_id ?>">
            ...
            <input type="text" name="lat_coord" id="lat_coord" aria-describedby="helper-text-explanation" class="mb-4 bg-white border border-green-700 p-2.5 pr-12 rounded-lg shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm w-full" value="<?= $this->model->lat_coord ?>" required>

            <label for="Lng" class="block mb-2 text-sm font-medium text-gray-900">Longitude </label>
            <input type="text" name="lon_coord" id="lon_coord" aria-describedby="helper-text-explanation" class="mb-4 bg-white border border-green-700 p-2.5 pr-12 rounded-lg shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm w-full" value="<?= $this->model->lon_coord ?>" required>

            <label for="Description" class="block mb-2 text-sm font-medium text-gray-900">Description</label>
            <textarea id="Description" name="description" rows="4" class="mb-4 bg-white border border-green-700 p-2.5 pr-12 rounded-lg shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm w-full" placeholder="Leave a description..."><?= $this->model->description ?></textarea>
